...
function Profile({ text, exit }: Profile) {
  return (
    <div className="w-screen h-screen flex items-center justify-center overlay">
      <div className="flex items-start justify-start w-96 p-6 bg-gray-300 rounded-lg border-2 border-gray-600 text-2xl font-bold flex-col gap-10">
